document.addEventListener("DOMContentLoaded", function () {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-custom">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.html">
                <img src="assets/app.ico" alt="UBot Icon" width="30" height="24" class="d-inline-block align-text-top">
                UBot
            </a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="communityDropdown">
                            ...
                            <li><a class="dropdown-item" href="https://github.com/mmaanniissaa93-pixel/ubot" target="_blank">GitHub</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="releasesDropdown">
                            <li><a class="dropdown-item" href="https://github.com/mmaanniissaa93-pixel/ubot/releases/latest" target="_blank">Latest Stable</a></li>
                            <li><a class="dropdown-item" href="https://github.com/mmaanniissaa93-pixel/ubot/releases" target="_blank">Nightly</a></li>
                            <li><a class="dropdown-item" href="https://github.com/warofmine/UBOT-Manager/releases/latest" target="_blank">Manager</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="projectDropdown">
                            <li><a class="dropdown-item" href="https://github.com/mmaanniissaa93-pixel/ubot" target="_blank">GitHub Repo</a></li>
                            <li><a class="dropdown-item" href="https://github.com/mmaanniissaa93-pixel/ubot/blob/master/LICENSE" target="_blank">License</a></li>
                            <li><a class="dropdown-item" href="https://app.fossa.com/projects/git%2Bgithub.com%2Fmmaanniissaa93-pixel%2Fubot?ref=badge_shield" target="_blank">FOSSA</a></li>
                        </ul>
                    </li>
                     <li class="nav-item">
  ...
  footer.innerHTML = `
        <div class="container-fluid">
            <p>&copy; 2025 UBot. All rights reserved.</p>
        </div>
    `;
