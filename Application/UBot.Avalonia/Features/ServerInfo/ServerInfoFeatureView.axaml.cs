...
namespace UBot.Avalonia.Features.ServerInfo;

public partial class ServerInfoFeatureView : UserControl
{
    private PluginViewModelBase? _vm;
    private AppState? _state;

    public ServerInfoFeatureView() { InitializeComponent(); }
    ...
    private void Build()
    {
        ...
        {
            Text = "ServerInfo â€” feature view (full implementation wired via FeatureViewFactory)",
            Classes = { "form-label" },
