...
namespace UBot.Avalonia.Features.AutoDungeon;

public partial class AutoDungeonFeatureView : UserControl
{
    private PluginViewModelBase? _vm;
    private AppState? _state;

    public AutoDungeonFeatureView() { InitializeComponent(); }
    ...
    private void Build()
    {
        ...
        {
            Text = "AutoDungeon â€” feature view (full implementation wired via FeatureViewFactory)",
            Classes = { "form-label" },
