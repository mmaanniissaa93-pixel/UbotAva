...
using System.Text;
using UBot.FileSystem.IO;
using UBot.FileSystem.PackFile;
using UBot.FileSystem.PackFile.Cryptography;
using UBot.FileSystem.PackFile.IO;
using UBot.FileSystem.PackFile.Struct;

namespace UBot.FileSystem;
