...
public class SpawnedItem : SpawnedEntity
{
    ...
    ///     The record.
    /// </value>
    public new RefObjItem Record => LegacyGame.ReferenceManager.GetRefItem(Id);
    ...
    /// <returns></returns>
    public static SpawnedItem FromPacket(Packet packet, uint itemId)
    {
