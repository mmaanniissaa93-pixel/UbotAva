...
public static class StatePacketExtensions
{
    public static void Deserialize(this State state, Packet packet)
    {
        ...
        if (LegacyGame.ClientType > GameClientType.Vietnam193)
            packet.ReadByte();
