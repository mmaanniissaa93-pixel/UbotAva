...
public class Action
{
    ...
    /// </value>
    public bool PlayerIsExecutor => LegacyGame.Player.UniqueId == ExecutorId;
    ...
    /// </value>
    public bool PlayerIsTarget => LegacyGame.Player.UniqueId == TargetId;
    ...
    public void ReadPacket(Packet packet)
    {
        ...
        if (Flag.HasFlag(ActionStateFlag.Teleport))
        {
            ...
            if (PlayerIsExecutor)
            {
                LegacyGame.Player.SetSource(position);
            }
            else
            {
