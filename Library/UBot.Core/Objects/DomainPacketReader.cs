...
{
    internal static Position ReadPosition(this Packet packet)
    {
        return new Position
        {
    ...
    internal static Position ReadPositionInt(this Packet packet)
    {
        return new Position
        {
            Region = packet.ReadUShort(),
    ...
    internal static Position ReadPositionConditional(this Packet packet, bool parseLayerWorldId = true)
    {
    ...
    internal static Movement ReadMotionMovement(this Packet packet)
    {
    ...
    internal static Movement ReadMovement(this Packet packet)
    {
    ...
    internal static RentInfo ReadRentInfo(this Packet packet, GameClientType clientType)
    {
    ...
    internal static MagicOptionInfo ReadMagicOptionInfo(this Packet packet)
    {
        return new MagicOptionInfo { Id = packet.ReadUInt(), Value = packet.ReadUInt() };
    }

    internal static BindingOption ReadBindingOption(this Packet packet, BindingOptionType type)
    {
    ...
    internal static SkillInfo ReadSkillInfo(this Packet packet)
    {
        return new SkillInfo(packet.ReadUInt(), packet.ReadBool());
    }

    internal static MasteryInfo ReadMasteryInfo(this Packet packet)
    {
        return new MasteryInfo { Id = packet.ReadUInt(), Level = packet.ReadByte() };
    }

    internal static PartyMember ReadPartyMember(this Packet packet)
    {
    ...
    internal static void Serialize(this Region region, Packet packet)
    {
...
internal static class DomainRuntimeBridge
{
...
#pragma warning restore CA2255
    ...
    private sealed class CorePositionRuntimeContext : IPositionRuntimeContext
    {
        ...
        {
            return Game.Player == null ? 0 : position.DistanceTo(Game.Player.Position);
        }
    ...
    private sealed class CoreSkillInfoRuntimeContext : ISkillInfoRuntimeContext
    {
        ...
        public int PlayerMana => Game.Player?.Mana ?? 0;

        public byte? GetMasteryLevel(uint masteryId)
        {
            return Game.Player?.Skills?.GetMasteryInfoById(masteryId)?.Level;
        }
