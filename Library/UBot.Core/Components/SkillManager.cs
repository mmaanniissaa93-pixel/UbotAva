...
public static class SkillManager
{
    ...
    private static readonly object _skillLock = new();
    ...
    /// </summary>
    public static bool UseSkillsInOrder => PlayerConfig.Get("UBot.Skills.checkUseSkillsInOrder", false);
    ...
    public static SkillInfo GetNextSkill()
    {
        ...
        lock (_skillLock)
        {
            ...
            {
                if (Skills.TryGetValue(monster.Rarity, out var raritySkills) && raritySkills.Count > 0)
