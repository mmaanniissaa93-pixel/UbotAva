...
public class PickupManager
{
    ...
    /// </value>
    public static bool PickupGold => PlayerConfig.Get("UBot.Items.Pickup.Gold", true);
    ...
    /// </value>
    public static bool PickupRareItems => PlayerConfig.Get("UBot.Items.Pickup.Rare", true);
    ...
    ///     <c>true</c> if [pickup rare items]; otherwise, <c>false</c>.
    /// </value>
    public static bool PickupBlueItems => PlayerConfig.Get("UBot.Items.Pickup.Blue", true);
    ...
    /// </value>
    public static bool PickupQuestItems => PlayerConfig.Get("UBot.Items.Pickup.Quest", true);
    ...
    /// </value>
    public static bool PickupAnyEquips => PlayerConfig.Get("UBot.Items.Pickup.AnyEquips", true);
    ...
    /// </value>
    public static bool PickupEverything => PlayerConfig.Get("UBot.Items.Pickup.Everything", true);
    ...
    /// </value>
    public static bool UseAbilityPet => PlayerConfig.Get("UBot.Items.Pickup.EnableAbilityPet", true);
    ...
    ///     <c>true</c> if [use ability pet]; otherwise, <c>false</c>.
    /// </value>
    public static bool JustPickMyItems => PlayerConfig.Get("UBot.Items.Pickup.JustPickMyItems", false);
    ...
    public static void LoadFilter()
    {
        ...
        var config = PlayerConfig.GetArray<string>("UBot.Shopping.Pickup");
    ...
    public static void SaveFilter()
    {
        ...
        PlayerConfig.SetArray("UBot.Shopping.Pickup", array);
    }
