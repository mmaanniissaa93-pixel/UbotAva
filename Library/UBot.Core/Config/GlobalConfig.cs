...
public static class GlobalConfig
{
    ...
    public static void Load()
    {
        ...
        // Migration: PR #934 "UBot.Default" was moved to "UBot.Training"
        if (
            _config.Exists("UBot.BotName")
            && _config.Get<string>("UBot.BotName") == "UBot.Default"
        )
        {
            _config.Set("UBot.BotName", "UBot.Training");
            _config.Save();
        }
