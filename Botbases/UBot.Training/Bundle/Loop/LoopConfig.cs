namespace UBot.Training.Bundle.Loop;
...
public class LoopConfig
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether buffs should be cast while running the walk-back script.
    /// </summary>
    public bool CastBuffsWhileWalkBack { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether buffs should be cast during town script execution.
    /// </summary>
    public bool CastBuffsInTowns { get; set; }
}
