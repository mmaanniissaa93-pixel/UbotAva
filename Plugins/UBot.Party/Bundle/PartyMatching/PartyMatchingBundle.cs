...
namespace UBot.Party.Bundle.PartyMatching;
...
internal class PartyMatchingBundle
{
    ...
    /// </summary>
    /// <returns><c>true</c> if the existing party matching entry is updated successfully; otherwise, <c>false</c>.</returns>
    public bool Change()
    {
        if (!HasMatchingEntry)
            return false;
    ...
    ///     Creates the specified settings.
    /// </summary>
    /// <returns><c>true</c> if a new party matching entry is created successfully; otherwise, <c>false</c>.</returns>
    public bool Create()
    {
        if (HasMatchingEntry)
            return false;
